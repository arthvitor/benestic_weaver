...
def bot_telegram(token=str, header_access=dict):
    ...
    if user_text == '/start':
        ...
        bot_text = 'Qual artista você gostaria de buscar? Digite buscar: (digite aqui seu artista)'
    
    elif 'buscar' in user_text:
        query = user_text[7:]
        ...
        {artist_name} tem {artist_followers} seguidores e tem {artist_pop}/100 de popularidade.
        {artist_name} faz parte dos seguintes gêneros: {artist_gen}'''
